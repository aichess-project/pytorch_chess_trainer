...
def find_run_config(input_file, output_file, substr1, substr2):
    # Read all lines from the input file
    with open(input_file, 'r') as infile:
        lines = infile.readlines()

    filtered_lines = [line for line in lines if substr1 in line and substr2 in line]
...
def main():
    ...
    find_run_config(input_filename, "run_config.log", "Run: ", "Trainer Config: Trainer_Config(")
